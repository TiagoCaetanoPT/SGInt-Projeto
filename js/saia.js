...
carregador.load(
    ...
    function (gltf) {
        ...
        saiaFechada = cena.getObjectByName('SaiaFechada');
        saiaFechada.position.set(0, 10, 0);
        saiaFechada.visible = true;
...
// Saia Aberta
carregador.load(
    '../modelos/saiaaberta.gltf',
    function (gltf) {
        cena.add(gltf.scene)

        saiaAberta = cena.getObjectByName('SaiaAberta');
        saiaAberta.position.set(0, 10, 0);
        saiaAberta.visible = false;
        // animacoes = gltf.animations
    }
)
...
function animar() {
    ...
    saiaAberta.rotateY(0.001);
    saiaFechada.rotateY(0.001);
...
function pegarPrimeiro() {
    ...
    if (intersetados.length > 0) {
        ...
        cena.getObjectByName('SaiaFechada').children[1].material = intersetados[0].object.material;
        cena.getObjectByName('SaiaAberta').children[1].material = intersetados[0].object.material;
    }
}

function AbrirFechar() {
    saiaAberta.visible = !saiaAberta.visible;
    saiaFechada.visible = !saiaFechada.visible;
}
